...
class TsmConfig:
    ...
    active_file_expectation_dynamics_features: bool = False
    ...
    active_file_calibration_tail_weight: float = 0.0
    active_file_calibration_tail_ratio_threshold: float = 0.5
